...
<div class="col-sm-8 text-left">
	<table class="createAccount" id="create-account">
		...
		<tbody>
			<form action="addArtist" method="post">
				...
				<tr>
					<th>User Id</th>
					<td><input type="number" id="user.id" name="user.id"
						value="${user.id }" style="color: black"></td>
				</tr>
				<tr>
					<th>Image Url</th>
				...
				<tr>
					<td><input type="submit" type="Create Artist"
						style="color: black" /></td>
				</tr>
			</form>
		</tbody>
	...
	<form action="deleteArtist" method="post">
		<input type="submit" value="Delete Artist" style="color: black">
	</form>
