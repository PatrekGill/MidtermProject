...
START TRANSACTION;
USE `audiofiledb`;
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `create_date`, `image_url`, `enabled`, `role`) VALUES (1, 'admin', 'admin', NULL, NULL, 'admin@gmail.com', NULL, NULL, 1, NULL);
...
START TRANSACTION;
USE `audiofiledb`;
INSERT INTO `album` (`id`, `title`, `description`, `release_date`, `image_url`, `user_id`) VALUES (1, 'A1A', 'A1A is the fifth studio album by American popular music singer-songwriter Jimmy Buffett and the third major label album in Buffett\'s Don Gant-produced \"Key West phase.\" It was initially released in December 1974 as Dunhill DS-50183 and later re-released on Dunhill\'s successor labels ABC and MCA.\n\nThe album is named for Florida State Road A1A that runs mostly along the Atlantic Ocean and is the main road through most oceanfront towns. It is also referenced in the song \"Trying To Reason With Hurricane Season\". The album\'s original back cover is a photograph of a section of A1A.', '1974-12-01', 'A1A_Front_Cover.jpg', 1);
INSERT INTO `album` (`id`, `title`, `description`, `release_date`, `image_url`, `user_id`) VALUES (2, '2', '2 is the debut full-length studio album by Canadian musician Mac DeMarco. It was recorded in June 2012, and released in October 2012 on the Captured Tracks label.', '2012-10-16', 'Macdemarco2cover.png', 1);
